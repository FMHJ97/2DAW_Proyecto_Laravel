                    ...
                    <div class="px-5 py-3 mt-auto border-t border-indigo-200 bg-indigo-50">
                        <div class="flex justify-between">
                            ...
                            <form action="{{ route('relatos.destroy', $relato) }}" method="POST" class="inline">
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-red-300"
                                    onclick="return confirm('¿Estás seguro de querer eliminar este relato?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
